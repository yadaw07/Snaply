...
| Home Feed                                            | Explore                                               |
| ---------------------------------------------------- | ----------------------------------------------------- |
| ![Home](https://placehold.co/400x250?text=Home+Feed) | ![Explore](https://placehold.co/400x250?text=Explore) |

| Profile                                               | Sign Up                                              |
| ----------------------------------------------------- | ---------------------------------------------------- |
| ![Profile](https://placehold.co/400x250?text=Profile) | ![Signup](https://placehold.co/400x250?text=Sign+Up) |
